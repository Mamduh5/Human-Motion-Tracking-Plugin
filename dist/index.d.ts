export declare const packageName = "human-motion-tracking-plugin";
...
export type { HolisticTrackerConfig, MotionLandmarkTracker, PoseTrackerConfig, TrackerProviderConfig, TrackerProviderMode, } from "./trackers/index";
